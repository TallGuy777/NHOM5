...
public class SanPhamAdapter extends  RecyclerView.Adapter<SanPhamAdapter.ViewHolder> {
    ...
    private  void showDialogUpdate(SanPham sanPham)
    {
        ...
        EditText edtLoaiSP=view.findViewById(R.id.edtLoai);
        ...
        btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String LoaiSanPham=edtLoaiSP.getText().toString();
                String GiaSanPham=edtGiaSP.getText().toString();
                SanPham sanPhamUpdate=new SanPham(sanPham.getMaloai(),TenSanPham,LoaiSanPham,GiaSanPham);
